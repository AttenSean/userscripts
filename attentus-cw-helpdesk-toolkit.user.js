...
// @version      0.2.0
// @description  ConnectWise help desk toolkit: ticket copy, confirmed UI-only clear/triage actions, board shoutouts, time-entry clipboard helpers, and tab title cleanup. No ConnectWise/ITGlue API writes.
